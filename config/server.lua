return {
    ...
    player = {
        hungerRate = 9.0, -- Rate at which hunger goes down.
        thirstRate = 9.0, -- Rate at which thirst goes down.
        ...
        identifierTypes = {
            ...
            AccountNumber = {
                valueFunction = function()
                    return 'US0' .. math.random(1, 9) .. 'NM' .. math.random(1111, 9999) .. math.random(1111, 9999) .. math.random(11, 99)
                end,
            },
            PhoneNumber = {
                valueFunction = function()
